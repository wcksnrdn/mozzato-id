  ...
  const products = [
    {
      ...
      price: "Rp 13,000",
      ingredients: ["Premium Potatoes", "Mozarella Cheese", "Wheat Flour", "High-Quality Butter", "Salt", "Yeast"],
    ...
    },    
    {
      ...
      price: "Rp 13,000",
      ingredients: ["Premium Potatoes", "Mozzarella Cheese", "Chocolate", "Wheat Flour", "High-Quality Butter", "Salt"],
    ...
    },    
    {
      ...
      price: "Rp 13,000",
      ingredients: ["Premium Potatoes", "Mozzarella Cheese", "Wheat Flour", "High-Quality Butter", "Salt"],
